    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-700 mb-6 leading-relaxed text-center">
          Welcome to <strong className="text-indigo-600">ShopiyStore</strong>!
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          <strong>ShopiyStore</strong> application. By using our app, you accept
          these terms in full. If you disagree with any part of these terms, you
          must not use our application.
        </p>
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          <strong>ShopiyStore</strong> is developed exclusively for educational
          purposes. It serves as a demonstration of React and Firebase
          integration in building a Japanese stationery shopping application.
        </p>
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          users. As a result, there are no user accounts, payment processing, or
          data storage mechanisms in place.
        </p>
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          property of <strong>ShopiyStore</strong> or its respective owners.
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          <strong>ShopiyStore</strong> is provided "as is" without any
          warranties, express or implied. We are not liable for any damages
          arising from the use or inability to use our application.
        </p>
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          continued use of the application constitutes acceptance of the revised
          terms.
        </p>
