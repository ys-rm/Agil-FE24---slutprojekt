    ...
    <>
      ...
      <meta
        ...
        content={`${product.name}, ${product.brand || ""}, ${
          product.type || ""
        }, ${product.tags?.join(", ") || ""}, stationery, online shopping`}
      />
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    <button
                      ...
                      className={`flex-1 py-3 px-6 rounded-lg text-white font-medium flex items-center justify-center space-x-2 ${
                        product.stock
                              ...
                              <div className="mt-1">
                                <div className="text-sm text-gray-700">
                                  ...
                                  {product.importDetails.country && (
                                    <span>
                                      {" "}
                                      from {product.importDetails.country}
                                    </span>
                                  )}
                                </div>
